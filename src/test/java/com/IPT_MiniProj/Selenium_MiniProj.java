...
public class Selenium_MiniProj extends Base_Class{
...
public static void paymentPage() throws Throwable {
	...
	cardno.click();
	Thread.sleep(5000);
	cardno.sendKeys("4012 8888 8888 1881");
	Thread.sleep(2000);
	r.keyPress(KeyEvent.VK_TAB);
...
public static void logout() {
	...
	WebElement close = driver.findElement(By.cssSelector("button.css-1iwzqhf.emgaj5l0"));
	close.click();
...
public static void screenshot(String filename) {
	...
	File desc = new File("C:\\Users\\DELL\\eclipse-workspace\\dhivakar\\NykaaIPT\\Screenshot\\"+filename+".png");
	try {
...
public static void removeItem() throws Throwable {
	...
	Thread.sleep(3000);
	WebElement bagitem = driver.findElement(By.xpath("//p[text()='1 Items']"));
	bagitem.click();
	
	Thread.sleep(3000);
	WebElement editbtn = driver.findElement(By.xpath("//p[text()='Edit']"));
	editbtn.click();
	
	Thread.sleep(3000);
	WebElement deleteitem = driver.findElement(By.xpath("//div[@class='css-1l5d7z5 e1whhlt1']"));
	deleteitem.click();
